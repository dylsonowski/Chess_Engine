...
namespace Pale {
	namespace Chess_Logic {
		...
		public:
			...
			Board_Representation(unsigned int row, unsigned int column) //todo: Make it diiferent way (first representation = object, object define value and start cords)
			...
			inline void SetPlateValue(unsigned int rowIt, unsigned int columnIt, T value) {
				try {
			...
			inline static void AddToDeathList(int figure) { s_deathList.emplace_back(figure); }
