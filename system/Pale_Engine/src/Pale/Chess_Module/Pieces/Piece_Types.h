...
namespace Pale {
	namespace Chess_Logic {
		...
		public:
			...
			bool MoveLogic(std::pair<unsigned int, unsigned int> endPos, std::vector<std::vector<std::shared_ptr<Pieces>>>& board) const override; //todo: Define move logic for king.
