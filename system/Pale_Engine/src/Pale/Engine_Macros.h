...
#define BAD_TYPE_CONVERSION					  "Attempt to convert on incorrect type!"
...
#define MATH__MATRICES_DIMENSIONS_INCORRECT	  "Operation cannot be performed because some dimensions are incorrect!"
...
#define NN__INVALID_POOLING_METHOD			  "Specified pooling method is not supported!"
